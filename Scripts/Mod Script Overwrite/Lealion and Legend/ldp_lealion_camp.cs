...
void main()
{
//    object oFollower = GetObjectByTag("gen00fl_lealion");
...
//        WR_SetPlotFlag(PLT_GEN00PT_PARTY_LEALION, GEN_LEALION_IN_PARTY, FALSE, FALSE);
//        WR_SetPlotFlag(PLT_GEN00PT_PARTY_LEALION, GEN_LEALION_IN_CAMP, TRUE, FALSE);
//    }
//    else
//    {
//        SetFollowerState(oFollower, FOLLOWER_STATE_AVAILABLE);
