//---------------------------------------------------------------------
/*
     Adds Legion to the party by tag, without location restriction

     usage:

        runscript ldp_legion_hire or talk to npc to hire it.

     Note:

        1. This file overwrite the original file "ldp_legion_hire.nss" to
        fix old problem.
