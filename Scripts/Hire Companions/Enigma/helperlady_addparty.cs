//---------------------------------------------------------------------
/*
     Adds Helperlady to the party by tag, without location restriction

     usage:

        runscript helperlady_addparty
...
void main()
{
    ...
    if(!IsObjectValid(oCreature)){
       oCreature = CreateObject(OBJECT_TYPE_CREATURE, R"enigma_helperlady.utc", GetLocation(OBJECT_SELF));
    }

    //Set plot flag "Recruited" to true for other feature
    WR_SetPlotFlag(PLT_ENIGMA_PLOT1, GEN_HELPERLADY_RECRUITED, TRUE);
